...
namespace cst {
    ...
    static const QVector <QString> tabNames = { "UI", "Card", "Relais", "Server", "Debug" };

    static const struct {
        QVector <QString> lines = { "Text" , "Initial number", "Interval", "Server Ip"};
        QVector <QString> checkBoxes = { "LFZeroFirst", "QRZeroFirst", "ArduinoZeroFirst", "LFzeroInside",
                                         "QRZeroInside", "ArduinoZeroInside", "LFTurnBytes", "QRTurnBytes",
                                         "ArduinoTurnBytes", "LFTurnBits", "QRTurnBits", "ArduinoTurnBits",
                                         "Exist" };
        QVector <QString> comboBoxes = { "Type" };
        QVector <QString> devices = { "LF", "QR", "Arduino" };
    } labelNames;

    static const struct {
        QVector <QString> lines = { "text", "relaisOne/initialNum", "relaisOne/interval",
