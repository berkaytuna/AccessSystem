...
public:
    ...
    bool getIsConnectedToSettings() { return _bIsConnectedToSettings; };
    void setIsConnectedToSettings(bool bInIsConnected) {
        _bIsConnectedToSettings = bInIsConnected;
        qDebug() << "Settings::_bIsConnectedToSettings: " + QString(_bIsConnectedToSettings);
    };
...
private:
    ...
    bool _bIsConnectedToSettings = false;
};
